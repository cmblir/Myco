...
엄격도·실행 일정은 설정에서 조정합니다. 압축은 두 단계로 이뤄집니다 — 하루치
세션 로그는 `daily/`로, 마감된 한 주의 일일 다이제스트는 `weekly/`로 모이고,
각 단계의 원본은 요약된 뒤 콜드 아카이브로 옮겨집니다. 클러스터별 토픽 맵을
...
vault 경로, 이 기기의 식별 정보는 담기지 않습니다.
